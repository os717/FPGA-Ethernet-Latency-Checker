# Tcl script for generating 'retransmitter_node' Vivado project
...
# Create project
create_project retransmitter_node $origin_dir/projects/retransmitter_node -part $part

# Project properties
set obj [get_projects retransmitter_node]
...
set files [list \
	"[file normalize "$origin_dir/src/hdl/retransmitter_node/retransmitter_node.v"]"\
	"[file normalize "$origin_dir/src/hdl/retransmitter_node/retransmitter.v"]"\
...
# Top module
set_property "top" "retransmitter_node" $obj
